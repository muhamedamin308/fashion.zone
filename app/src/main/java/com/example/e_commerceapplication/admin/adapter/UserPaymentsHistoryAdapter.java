...
public class UserPaymentsHistoryAdapter extends RecyclerView.Adapter<UserPaymentsHistoryAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.users_history_list_item, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.price.setText(payments.get(position).getProductTotalPrice()+"$");
