...
public class MyCart implements Serializable {
    ...
    public MyCart(String productImage, String productName, String productDate, String productTime, String productRate, double productPrice, double totalPrice, int totalQuantity) {
        this.productImage = productImage;
        this.productName = productName;
        this.productDate = productDate;
        this.productTime = productTime;
